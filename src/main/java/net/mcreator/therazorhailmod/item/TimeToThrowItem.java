...
public class TimeToThrowItem extends TherazorhailModModElements.ModElement {
	@ObjectHolder("therazorhail_mod:time_to_throw")
	public static final Item block = null;
	public TimeToThrowItem(TherazorhailModModElements instance) {
		super(instance, 8);
	}
